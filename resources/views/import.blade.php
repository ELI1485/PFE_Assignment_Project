    ...
    <div class="import-page">
        <div class="page-actions">
            <div>
                <div class="section-subtitle">
                    Téléchargez le modèle Excel, remplissez ses 2 feuilles (Étudiants et Professeurs), puis importez-le ici.
                </div>
            </div>
        ...
        <div class="card import-card">
            <div class="import-card-head">
                ...
                <p>Un seul fichier Excel contenant les 2 feuilles attendues : Étudiants (toutes filières confondues) et Professeurs.</p>
            </div>
            <div class="import-card-body">
                <div class="sheet-legend">
                    <span class="sheet-pill"><i class="bi bi-1-circle"></i> Feuille 1 — Étudiants (toutes filières)</span>
                ...
                <form action="{{ route('import.unified') }}" method="POST" enctype="multipart/form-data" id="formUnifiedImport">
                    ...
                    <div class="drop-zone" id="dropUnified" onclick="document.getElementById('fileUnified').click()">
                        ...
                        <p class="drop-title">Déposer votre fichier Excel contenant 2 feuilles</p>
                        <p class="drop-sub">Formats acceptés : .xls, .xlsx — Un seul fichier avec les feuilles Étudiants et Professeurs.</p>
