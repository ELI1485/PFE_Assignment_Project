    ...
    <div class="card">
        ...
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Nom du Site (Barre latérale)</label>
                    <input type="text" name="site_name" class="form-control" value="{{ old('site_name', $config['site_name']) }}" placeholder="ex: PFE.Admin">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Sous-titre du Site (Barre latérale)</label>
                    <input type="text" name="site_subtitle" class="form-control" value="{{ old('site_subtitle', $config['site_subtitle']) }}" placeholder="ex: ENSAH">
                </div>
                <div class="col-md-8">
